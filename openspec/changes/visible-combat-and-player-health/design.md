...
- Should bases/towers themselves participate in `unit-combat-targeting` (i.e., shoot at nearby enemies) in this change, or stay passive HP pools? Current proposal treats bases as respawn points only; base auto-defense is left as a possible follow-up.
